										...
										<table width="100%" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:16px/29px Arial, Helvetica, sans-serif; color:#888; padding:0 0 21px;">
													...
													<p>Se ha generado este correo dado a que el espacio de almacenamiento en el servidor se encuentra en un estado crítico, superando el 90% de utilización.</p>
													<p>Se recomienda contactar de forma inmediata a un especialista para evitar posibles problemas en el panel de gestión.</p>
												</td>
											</tr>
										</table>
									</td>
